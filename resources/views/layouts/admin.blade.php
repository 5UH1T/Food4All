                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.dashboard') }}"
                            class="sidebar-link rounded-lg d-flex align-items-center gap-1 px-4 py-3 {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.categories') }}"
                            class="sidebar-link rounded-lg d-flex align-items-center gap-1 px-4 py-3 {{ request()->routeIs('admin.categories') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.vendors') }}"
                            class="sidebar-link rounded-lg d-flex align-items-center gap-1 px-4 py-3 {{ request()->routeIs('admin.vendors') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.users') }}"
                            class="sidebar-link rounded-lg d-flex align-items-center gap-1 px-4 py-3 {{ request()->routeIs('admin.users') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.attributes') }}"
                            class="sidebar-link rounded-lg d-flex align-items-center gap-1 px-4 py-3 {{ request()->routeIs('admin.attributes') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.settings') }}"
                            class="sidebar-link rounded-lg d-flex align-items-center gap-1 px-4 py-3 {{ request()->routeIs('admin.settings') ? 'active' : '' }}">
                    ...
                    <ul class="navbar-nav navbar-align flex items-center justify-center gap-2">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="#"
                                    class="d-flex justify-content-start align-items-center gap-2 py-3 hover:bg-gray-100 text-sm text-gray-700 dropdown-item">
