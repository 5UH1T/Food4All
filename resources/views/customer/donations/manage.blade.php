...
@section('customer_content')
    ...
    <h2 class="text-center mb-5">All Donations</h2>
            ...
            <table class="w-full text-left">
                ...
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="p-3">Donation (In Amount)</th>
                    ...
                    @else
                        @foreach ($orders as $index => $order)
                            <tr class="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <td class="p-3">
                                    @php
                                        $donated_amt = $order->items->sum(function ($item) {
                                            return $item->donation_quantity * ($item->total_price / $item->quantity);
                                        });
                                    @endphp
                                    Rs. {{ $donated_amt }}
                                </td>
