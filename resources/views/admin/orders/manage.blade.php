            ...
            <table class="datatable w-full text-left">
                ...
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="p-3 text-lg font-semibold text-gray-600">Order ID</th>
                        <th class="p-3 text-lg font-semibold text-gray-600">Ordered By</th>
                        <th class="p-3 text-lg font-semibold text-gray-600">Ordered From</th>
                        <th class="p-3 text-lg font-semibold text-gray-600">Status</th>
                        <th class="p-3 text-lg font-semibold text-gray-600">Ordered Date</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                        ...
                        <td class="p-3 text-right">
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewOrder">
                                View Details
                            </button>
                        </td>
